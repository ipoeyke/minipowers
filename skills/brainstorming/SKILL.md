...
5. **Write design doc** — save to `docs/minipowers/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `docs/minipowers/specs/YYYY-MM-DD-<topic>-design.md`
